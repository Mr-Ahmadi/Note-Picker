    ...
    return (
        <>
            <Modal show={show} onHide={resetModel}>
                ...
                <Modal.Body>
                    {notes.length 
                    ? notes.map(note => <Notes key={note._id} note={note} isLast={note._id === notes[notes.length - 1]._id}/>)
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" disabled={processing} onClick={_ => exportPDF(jsPDF, originalname, notes, setProcessing)}>
